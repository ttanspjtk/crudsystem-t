    ...
    return (
        <div className="container p-4 ">
            ...
            <div class="row">
                ...
                <div class="col-9"><input type="number" onChange={(e) => onValueChange(e)} name="รหัสนักวิจัย" value={รหัสนักวิจัย}/></div>
            </div>     
            <div class="row">
                <div class="col-3"><p>หมายเลขบัตรประชาชน*</p></div>
                <div class="col-9"><input type="number" onChange={(e) => onValueChange(e)} name="หมายเลขบัตรประชาชน" value={หมายเลขบัตรประชาชน} required/></div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-1"><p>เพศ</p></div>
                <div class="col-11">
                    <input class="form-check-input mx-2" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="ชาย" /> ชาย
                    <input class="form-check-input mx-2" type="radio" name="flexRadioDefault" id="flexRadioDefault2" value="หญิง" checked/> หญิง  
                </div>
            </div>
            <div class="row">
            ...
            <div className="d-sm-flex ">
                <button className="btn btn-success" onClick={() => editUserDetails()}>Edit</button>
            </div>
        </div>
    );
};
